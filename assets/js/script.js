(function () {
  ...
  var ranges = doc.querySelectorAll('[type="range"]');
  ...
  var uls = Array.from(doc.querySelectorAll('.typeface')),
      active = 1,
      scroll_tick = false;
      ...
      window.requestAnimationFrame(function () {
        uls.forEach(function (ul) {
          var rect = ul.getBoundingClientRect(),
              ...
              bottom = rect.bottom;
          if (top <= 0 && bottom > 0) {
            var active_tem = uls.indexOf(ul) + 1;
            if (active_tem !== active) {
              body.setAttribute('data-active', active_tem);
              active = active_tem;
            }
          }
        });
